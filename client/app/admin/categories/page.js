...
export default function AdminCategories() {
    ...
    const saveEdit = (id) => {
        setCategories((prev) =>
            prev.map((c) => (c.id === id ? { ...c, name: editName.trim() || c.name } : c))
        );
        setEditId(null);
        setEditName("");
    };
    ...
    return (
        <div className="max-w-2xl">
            <div className="mb-10">
                <h1 className="text-3xl font-medium tracking-tighter uppercase">Categories</h1>
            ...
            <div className="bg-white border border-gray-100 rounded-sm p-6 mb-6">
                <h2 className="text-xs font-medium uppercase tracking-widest mb-5">New Category</h2>
            ...
            <div className="bg-white border border-gray-100 rounded-sm overflow-hidden">
                ...
                <ul className="divide-y divide-gray-50">
                    {categories.map((c) => (
                        <li key={c.id} className="flex items-center justify-between px-6 py-4 hover:bg-gray-50/50 transition-colors">
