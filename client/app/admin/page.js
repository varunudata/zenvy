  ...
  return (
    <div className="bg-white border border-gray-100 rounded-sm p-6">
      <div className="flex items-start justify-between mb-4">
        <span className="text-[var(--color-muted-foreground)] text-xs uppercase tracking-widest">
          {label}
        </span>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100">
              <th className="text-left px-6 py-3 text-xs text-[var(--color-muted-foreground)] uppercase tracking-widest font-medium">
                Name
              </th>
              <th className="text-left px-6 py-3 text-xs text-[var(--color-muted-foreground)] uppercase tracking-widest font-medium">
                Category
            ...
            {RECENT.map((p) => (
              <tr key={p.id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <span
                    className={`inline-flex items-center px-2 py-0.5 text-xs rounded-sm font-medium ${
                      p.quantity < 20
