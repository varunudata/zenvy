...
const PRODUCT = {
  ...
  price: 45,
  description:
    'The foundational piece of any wardrobe. Crafted from heavyweight, 100% organic cotton jersey.',
  quantity: 120,
  categoryId: 1,
};
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-10">
        ...
        <h1 className="text-3xl font-medium tracking-tighter uppercase mt-4">
          Edit Product
        </h1>
      ...
      <form
        ...
        className="bg-white border border-gray-100 rounded-sm p-8 space-y-8"
      >
        <div>
