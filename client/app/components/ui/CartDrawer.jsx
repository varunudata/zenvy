    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 w-full md:w-[480px] bg-white shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-6 border-b border-[var(--color-border)]">
          <h2 className="text-lg font-medium tracking-tighter uppercase">
            Your Cart (1)
          </h2>
          <button
            onClick={onClose}
            ...
            <div className="flex-1 flex flex-col justify-between">
              <div>
                <div className="flex justify-between">
                  ...
                  <button
                    className="text-[var(--color-muted-foreground)] hover:text-black"
                    aria-label="Remove item"
                  >
                    <XIcon size={16} />
                  </button>
                </div>
                <p className="text-xs text-[var(--color-muted-foreground)] uppercase tracking-widest mt-1">
                  Size: M
                </p>
              </div>
              <div className="flex justify-between items-end">
                <div className="flex items-center border border-[var(--color-border)]">
                  <button className="px-3 py-1 text-[var(--color-muted-foreground)] hover:text-black transition-colors">
                    −
                  </button>
        ...
        <div className="border-t border-[var(--color-border)] p-6 bg-gray-50/50">
          <div className="flex justify-between mb-2">
            <span className="text-sm text-[var(--color-muted-foreground)] tracking-wide">
              Subtotal
            </span>
          ...
          <div className="mt-4 text-center">
            <button
              onClick={onClose}
              className="text-xs uppercase tracking-widest text-[var(--color-muted-foreground)] hover:text-black transition-colors underline underline-offset-4"
            >
              Continue Shopping
            </button>
          </div>
