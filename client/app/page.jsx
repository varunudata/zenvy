...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section — uses CSS background for instant dev render */}
      <section
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
          <span className="text-xs uppercase tracking-[0.3em] font-medium mb-6 text-black/70">
      ...
      <section className="py-24 md:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          ...
          <Link
            href="/shop"
            className="text-sm uppercase tracking-widest font-medium border-b border-black pb-1 hover:text-gray-600 hover:border-gray-600 transition-colors mt-6 md:mt-0 inline-block"
          >
            View All
          </Link>
        </div>
