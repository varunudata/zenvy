        ...
        <div className="w-full md:w-1/2">
          <div className="sticky top-28 space-y-4">
            {images.map((src, idx) => (
              <div
                key={idx}
                className="relative aspect-[3/4] w-full bg-gray-50"
              >
                <Image
                  src={src}
        ...
        <div className="w-full md:w-1/2">
          <div className="md:sticky md:top-28">
            ...
            <div className="prose prose-sm text-[var(--color-muted-foreground)] leading-relaxed mb-10 border-t border-[var(--color-border)] pt-8">
              <p>
                The foundational piece of any wardrobe. Crafted from
                heavyweight, 100% organic cotton jersey that becomes beautifully
                worn with time. Features a ribbed crewneck, drop shoulder, and a
                relaxed boxy fit. Pre-shrunk for enduring shape.
              </p>
            ...
            <div className="mb-10">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-xs text-[var(--color-muted-foreground)] underline tracking-wide">
                  Size Guide
                </button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <Button
                variant="outline"
                size="full"
                className="font-normal text-[var(--color-muted-foreground)] hover:text-black"
              >
                Add to Wishlist
              </Button>
            </div>
              ...
              {[
                {
                  ...
                  content:
                    'Free standard shipping on orders over $150. Returns accepted within 14 days of delivery.',
                },
                {
                  title: 'Care Instructions',
                  content:
                    'Machine wash cold with like colors. Tumble dry on low heat. Do not bleach.',
                },
              ].map((item, idx) => (
                <div
                  key={idx}
