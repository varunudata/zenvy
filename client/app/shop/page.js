                    ...
                    <div className="sticky top-28">
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <ul className="space-y-3">
                                    {CATEGORIES.map((cat) => (
                                        <li key={cat}>
                                            <button
                                                className={`text-sm tracking-wide ${cat === "All"
                                                        ? "font-medium text-black"
                                                        : "text-[var(--color-muted-foreground)] hover:text-black transition-colors"
                                                    }`}
                                            >
                                                {cat}
                                            </button>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    {["Newest Arrivals", "Price: Low to High", "Price: High to Low"].map((opt, i) => (
                                        <li key={opt}>
                                            <button
                                                className={`text-sm tracking-wide ${i === 0
                                                        ? "font-medium text-black"
                                                        : "text-[var(--color-muted-foreground)] hover:text-black transition-colors"
                                                    }`}
                                            >
